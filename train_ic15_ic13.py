...
def train(source_train_loader, model, criterion, optimizer, epoch):
...
def main(args):
    ...
    scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=10, threshold=args.lr/100)
    current_epoch_num = 0
